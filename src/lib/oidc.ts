// OIDC RP 侧小件（统一认证迁移步骤②，auth 项目 PRD P0-5）：
...
export const OIDC_SESSION_COOKIE = '__Host-club_session';
// authorize 跳转前的 state/nonce/verifier 中转（10 分钟寿命，登录完成后即删）
export const OIDC_TEMP_COOKIE = '__Host-club_oidc';
// 静默同步探测（prompt=none，进站即探测）的冷却标记：无会话访客 10 分钟内不重复探测
export const OIDC_PROBE_COOKIE = '__Host-club_probe';
