...
**实测**：typecheck 三份全清；vitest **51 文件 / 727 例全绿**；build 成功（主 bundle gzip 183.15 KB，较 v6.1.1 +0.7 KB）；e2e **11/11**；五态浏览器手测（本地夹具临时翻转、测后还原）逐态断言全中、375 窄屏零溢出，截图落 `scratch/manual-*.png`。
